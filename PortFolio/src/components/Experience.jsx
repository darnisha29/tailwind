...
const Experience = () => {
  return (
    <div className='border-b border-neutral-900 pb-'>
        ...
        return (<div key={index} className='mb-8 flex flex-wrap lg:justify-center'>
            ...
            <div className='w-full max-w-xl lg:w-3/4'>
                ...
                {experience.technologies.map((tech,index) => {
                    return( <div key={index} className='mr-2 mt-4 rounded bg-neutral-900 px-2 py-1 text-sm font-medium text-purple-700'>{tech}</div>)
                })}
                </div>
            </div>
        </div>) 
